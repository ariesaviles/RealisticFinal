...
class AppStateWE: ObservableObject {
    @Published var simpleFlag = false
}

struct  ExpressionView: UIViewControllerRepresentable {
//    @ObservedObject var fsettings : FloorSettings
    typealias UIViewControllerType = ExpressionController
    
    @EnvironmentObject var settings: AppStateWE
    
    func makeUIViewController(context: Context) -> ExpressionController {
        let  ExpressionViewController = UIViewControllerType()
//         ExpressionViewController.fsettings = fsettings
//        let  ExpressionViewController = UIStoryboard(name: "Test", bundle: nil).instantiateViewController(identifier: String(describing: ExpressionController.self)) as! ExpressionController
//         ExpressionViewController.settings = fsettings
//          ExpressionView.delegate = context.coordinator
        return  ExpressionViewController
    }
    ...
    func makeCoordinator() ->  ExpressionView.Coordinator {
...
extension  ExpressionView {
    class Coordinator /*: SomeUIKitViewDelegate */ {
        var parent:  ExpressionView
        
        init(_ parent:  ExpressionView) {
            self.parent = parent
        }
...
class ExpressionController: UIViewController, UICollisionBehaviorDelegate {
    
    var fullFloorImg: String = "expressions-full"
...
extension ExpressionController {
