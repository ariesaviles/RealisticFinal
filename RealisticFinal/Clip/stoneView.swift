...
struct  StoneView: UIViewControllerRepresentable {
//    @ObservedObject var fsettings : FloorSettings
    typealias UIViewControllerType = StoneController
    
    @EnvironmentObject var settings: AppStateRD
    
    func makeUIViewController(context: Context) -> StoneController {
        let  StoneViewController = UIViewControllerType()
//         StoneViewController.fsettings = fsettings
//        let  StoneViewController = UIStoryboard(name: "Test", bundle: nil).instantiateViewController(identifier: String(describing: StoneController.self)) as! StoneController
//         StoneViewController.settings = fsettings
//          StoneView.delegate = context.coordinator
        return  StoneViewController
    }
    ...
    func makeCoordinator() ->  StoneView.Coordinator {
...
class StoneController: UIViewController, UICollisionBehaviorDelegate {
    
    var fullFloorImg: String = "revivalmaria-full"
    var wallTexture: String = "CollisionSmall"
    var floorTexture: String = "Texture-stoneclip"
...
//        floorTexture = settings.ahapName
    ...
    private func initializeBackgroundImage() {
        let backgroundImagePath = Bundle.main.path(forResource: "stone-full",
                                                   ofType: "jpeg")!
