...
class AppStateBV: ObservableObject {
    @Published var simpleFlag = false
}

struct  BascilicaView: UIViewControllerRepresentable {
//    @ObservedObject var fsettings : FloorSettings
    typealias UIViewControllerType = BascilicaController
    
    @EnvironmentObject var settings: AppStateBV
    
    func makeUIViewController(context: Context) -> BascilicaController {
        let  BascilicaViewController = UIViewControllerType()
//         BascilicaViewController.fsettings = fsettings
//        let  BascilicaViewController = UIStoryboard(name: "Test", bundle: nil).instantiateViewController(identifier: String(describing: BascilicaController.self)) as! BascilicaController
//         BascilicaViewController.settings = fsettings
//          BascilicaView.delegate = context.coordinator
        return  BascilicaViewController
    }
    ...
    func makeCoordinator() ->  BascilicaView.Coordinator {
        return Coordinator(self)
    }
}

extension  BascilicaView {
    class Coordinator /*: SomeUIKitViewDelegate */ {
        var parent:  BascilicaView
        
        init(_ parent:  BascilicaView) {
            self.parent = parent
        }
...
struct  BascilicaView_Previews: PreviewProvider {
    static var previews: some View {
         BascilicaView()
    }
}

class BascilicaController: UIViewController, UICollisionBehaviorDelegate {
    
    var fullFloorImg: String = "brascilica-full"
