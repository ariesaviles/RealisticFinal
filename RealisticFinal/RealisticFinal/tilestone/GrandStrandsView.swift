...
class AppStateGS: ObservableObject {
    @Published var simpleFlag = false
}

struct  GrandStrandsView: UIViewControllerRepresentable {
//    @ObservedObject var fsettings : FloorSettings
    typealias UIViewControllerType = GrandStrandsController
    
    @EnvironmentObject var settings: AppStateGS
    
    func makeUIViewController(context: Context) -> GrandStrandsController {
        let  GrandStrandsViewController = UIViewControllerType()
//         GrandStrandsViewController.fsettings = fsettings
//        let  GrandStrandsViewController = UIStoryboard(name: "Test", bundle: nil).instantiateViewController(identifier: String(describing: GrandStrandsController.self)) as! GrandStrandsController
//         GrandStrandsViewController.settings = fsettings
//          GrandStrandsView.delegate = context.coordinator
        return  GrandStrandsViewController
    }
    ...
    func makeCoordinator() ->  GrandStrandsView.Coordinator {
        return Coordinator(self)
    }
}

extension  GrandStrandsView {
    class Coordinator /*: SomeUIKitViewDelegate */ {
        var parent:  GrandStrandsView
        
        init(_ parent:  GrandStrandsView) {
            self.parent = parent
        }
...
struct  GrandStrandsView_Previews: PreviewProvider {
    static var previews: some View {
         GrandStrandsView()
    }
}

class GrandStrandsController: UIViewController, UICollisionBehaviorDelegate {
    
    var fullFloorImg: String = "grandstrands-full"
    var wallTexture: String = "CollisionSmall"
    var floorTexture: String = "Texture-stone"
...
extension GrandStrandsController {
